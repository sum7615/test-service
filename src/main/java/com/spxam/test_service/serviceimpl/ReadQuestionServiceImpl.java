...
public class ReadQuestionServiceImpl implements IReadQuestionService {
    ...
    public List<QuestionDataRes> getQuestions(String userName, Long questionBankId) {
        ...
        return iQuestionRepo.findByQuestionBankId(questionBankId, userName)
                .stream()
                .map(q -> QuestionDataRes.builder()
                        .id(q.getId())
                        .title(q.getTitle())
                        .problemStatement(q.getProblemStatement())
                        .problemStatementImg(q.getProblemStatementImg())
                        .o1(q.getO1())
                        .o2(q.getO2())
                        .o3(q.getO3())
                        .o4(q.getO4())
